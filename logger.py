...
COMMON_TRAIN_FORMAT = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                       ...
                       ('episode_reward', 'R', 'float'), ('task_id', 'TASK', 'int'),
...
COMMON_TRAIN_FORMAT_METAWORLD = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                       ('episode', 'E', 'int'), ('episode_length', 'L', 'int'),
                       ('episode_reward', 'R', 'float'), ('task_id', 'TASK', 'int'), ('success', 'SUC', 'float'),
                       ('fps', 'FPS', 'float'), ('total_time', 'T', 'time')]

COMMON_EVAL_FORMAT_METAWORLD = [('frame', 'F', 'int'), ('step', 'S', 'int'),
                      ('episode', 'E', 'int'), ('episode_length', 'L', 'int'),
                      ('episode_reward', 'R', 'float'), ('task_id', 'TASK', 'int'), ('success', 'SUC', 'float'),
                      ('total_time', 'T', 'time')]
...
class Logger(object):
    def __init__(self, log_dir, use_tb, use_wandb, env_type="dm_control"):
        ...
        if env_type == "dm_control":
            ...
            self._train_mg = MetersGroup(log_dir / 'train.csv',
                                         formating=COMMON_TRAIN_FORMAT_METAWORLD,
                                         use_wandb=use_wandb)
            self._eval_mg = MetersGroup(log_dir / 'eval.csv',
                                        formating=COMMON_EVAL_FORMAT_METAWORLD,
                                        use_wandb=use_wandb)
